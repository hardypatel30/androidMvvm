...
public class GenericAdapter<T, VM extends ViewDataBinding> extends RecyclerView.Adapter<GenericAdapter.RecyclerViewHolder> {
    private final Context context;
    private ArrayList<T> items;
    private int layoutId;
    private RecyclerCallback<VM, T> bindingInterface;

    public GenericAdapter(Context context, ArrayList<T> items, int layoutId, RecyclerCallback<VM, T> bindingInterface) {
        this.items = items;
